        ...
        <div class="row">
            ...
            <div class="col-4">
                <form id="formData" method="post" enctype="multipart/form-data">
                    ...
                    <button onclick="addData()" id="addBtn" class="btn btn-sm bg-primary mr-2 d-inline">
                        Add
                    </button>
                    <button onclick="updateData()" id="updateBtn" class="btn btn-sm bg-success mr-2 d-inline">
                        Update
                    </button>
